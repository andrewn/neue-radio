...
APP_URL=http://localhost:$INTERNAL_PORT/manager
ARGS="--disable-gpu --remote-debugging-port=$REMOTE_DEBUGGING_PORT --remote-debugging-address=$REMOTE_DEBUGGING_ADDRESS $APP_URL"
